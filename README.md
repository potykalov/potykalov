...
**Junior Frontend Developer | JavaScript, TypeScript, HTML, CSS**

Разрабатываю учебные веб-приложения, браузерные игры и адаптивные сайты. Работаю с JavaScript, TypeScript, DOM API и REST API.
...
**Frontend:** HTML5, CSS3, JavaScript, TypeScript, DOM API, адаптивная вёрстка, Flexbox, CSS Grid, БЭМ.
...
**Проекты:** [Retro Game](#retro-game--пошаговая-браузерная-игра) · [Financial Management App](#financial-management-app--учёт-личных-финансов) · [NOEMI](#noemi--адаптивная-вёрстка-сайта) · [Неткоин](#неткоин--управление-внутренней-валютой) · [Крестики-нолики](#дополнительные-проекты) · [Виселица](#дополнительные-проекты)
...
SPA-приложение для управления счетами, доходами, расходами и историей транзакций.
...
<p align="center">
<img
  src="https://raw.githubusercontent.com/potykalov/mq-diploma/main/assets/preview.jpg"
  width="350"
...
Веб-приложение для управления балансом, конвертации внутренней валюты и переводов между пользователями.
...
Прохожу обучение в Нетологии по программе **«Фронтенд-разработчик: расширенный курс»**.
